...
- `.default(value)` for defaults (rendered as optional in the editor UI)
- `z.enum([...])` for dropdowns in the editor
...
// The editor auto-generates palette entry, config panel, and connection handles
