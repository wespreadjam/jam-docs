...
<AccordionGroup>
  <Accordion title="Install our GitHub app">
...
<Accordion title="Update your site name and colors">
...
<Accordion title="Publish your docs">
...
<Card title="Write Content" href="/essentials/markdown">
  Learn MDX syntax and start writing your documentation.
</Card>

<Card title="Customize style" href="/essentials/settings">
  Make your docs match your brand perfectly.
</Card>

<Card title="Add code examples" href="/essentials/code">
