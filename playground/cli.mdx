...
| Service | Variable |
|---------|----------|
| Apollo.io | `JAM_APOLLO_API_KEY` |
| Hunter.io | `JAM_HUNTER_API_KEY` |
| OpenAI | `JAM_OPENAI_API_KEY` |
| Anthropic | `JAM_ANTHROPIC_API_KEY` |
| Twitter | `JAM_TWITTER_BEARER_TOKEN` |
| Reddit | `JAM_REDDIT_CLIENT_ID`, `JAM_REDDIT_CLIENT_SECRET` |
| LinkedIn | `JAM_LINKEDIN_ACCESS_TOKEN` |
| DataForSEO | `JAM_DATAFORSEO_LOGIN`, `JAM_DATAFORSEO_PASSWORD` |
| SendGrid | `JAM_SENDGRID_API_KEY` |
